"""
Django settings for e_shopper_project project.
...
SECRET_KEY = 'django-insecure-nj(&x$2#4oja%1ntp@6r-)((^+^!kca_xpsoc@0_38*n)rp5y7'
...
WSGI_APPLICATION = '_e_shopper.wsgi.application'
